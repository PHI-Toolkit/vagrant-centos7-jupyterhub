...
Vagrant.configure("2") do |config|
  ...
  #config.vm.customize ['createhd', '--filename', '/data/vagrant/centos7.vdi', '--size', 307200]
  #config.vm.customize ['storageattach', :id, '--storagectl', 'SATAController', '--port', 1, '--device', 0, '--type', 'hdd', '--medium', '/data/vagrant/centos7.vdi']
